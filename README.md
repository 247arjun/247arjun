...
- 🛠️ I led the design, development and open-sourcing of the [`AntiSSRF` secure code libraries](https://github.com/microsoft/antissrf) that help protect online services against SSRF risk.
...
- 👨‍🏫 I co-delivered a workshop on [leveraging AI with SAST](https://defcon.org/html/defcon-32/dc-32-workshops.html#54210), at **DEF CON 32** and **BSides Seattle**.
